...
/*
1 - Décompresserzl'archive zip dans le répertoire de votre choix.
...
function createHTML(books) {
    ...
    <div class="titre reco_title">
        ...
        <img id="reco_waiting" src="${chrome.runtime.getURL('waiting.gif')}" style="display:none;" />
    </div>
...
function createHTMLWeights() {
    ...
    #bookreco_close:hover {
        color:#FFF8;
    }
    </style>
    <div id="bookreco_weights" style="display:none;">
        <button id='bookreco_close'>X</button>
    ...
    document.getElementById("bookreco_close").onclick = function () {
    ...
    document.getElementById("bookreco_button").onclick = function () {
        ...
        toggle_waiting(doWait = true)
        getData();
    }
}

function toggle_waiting(doWait) {
    if (doWait) {
        document.getElementById("reco_waiting").style.display = "";
        document.getElementById("reco_button").style.display = "none";
    }
    else {
        document.getElementById("reco_waiting").style.display = "none";
        document.getElementById("reco_button").style.display = "";
    }
}
