...
fig.update_layout(
    ...
    annotations=[dict(text=s[0], x=-0.03, y=-0.14, font_size=12, showarrow=False, textangle=-45),
                 ...
                 dict(text=s[3], x=0.49, y=0.02, font_size=12, showarrow=False, textangle=-45),
                 ...
                 dict(text=s[6], x=0.95, y=0.09, font_size=12, showarrow=False, textangle=-45),
                ])
